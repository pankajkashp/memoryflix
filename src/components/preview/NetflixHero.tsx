  ...
  return (
    <div className="relative h-[60vh] md:h-[70vh] w-full bg-zinc-900 flex items-end">
      ...
      <div className="relative z-10 w-full px-6 pb-12 md:px-12 md:pb-16 max-w-4xl">
        ...
        <h1 className="text-3xl md:text-6xl lg:text-7xl font-bold text-white mb-3 md:mb-4 tracking-tight drop-shadow-lg">
          {story.title}
        </h1>
        {story.description && (
          <p className="text-white/90 text-sm md:text-base lg:text-lg max-w-2xl mb-6 md:mb-8 drop-shadow-md line-clamp-3">
            {story.description}
          </p>
        )}
        {/* Play button */}
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6">
          ...
          <button className="w-full sm:w-auto bg-zinc-500/50 text-white min-h-[44px] px-6 py-3 md:px-8 md:py-3 rounded flex items-center justify-center gap-2 font-semibold hover:bg-zinc-500/70 transition backdrop-blur-sm">
